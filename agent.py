#C:/Users/dange/OneDrive/Desktop/Portfolio/Snake-AI/agent.py
...
class Agent:
    def __init__(self):
        ...
        self.gamma = 0.9 #discount rate on bellman equation
    ...
    def get_state(self, snake):
        ...
        state = [
            ...
            #food location
            snake.food.x < snake.head.x, #food is left
            snake.food.x > snake.head.x, #food is right
            snake.food.y < snake.head.y, #food is up
            snake.food.y > snake.head.y #food is down
        ]
    ...
    def remember(self, state, action, reward, next_state, done):
        self.memory.append((state, action, reward, next_state, done)) #pops left is max
    ...
    def get_action(self, state):
        #random moves  in beginning: tradeoff between exploration and exploitation
